# 🛵 Entregas Rápidas - Problema de Lógica em Prolog

## 📖 Descrição - Atividade 1
Este projeto é uma implementação em **Prolog** do problema de lógica *“Entregas Rápidas”*, um desafio do tipo Racha Cuca. O objetivo é deduzir as características de cinco motoboys 🏍️ e suas entregas 📦 em diferentes regiões da cidade 🏙️ a partir de um conjunto de pistas fornecidas.

O exercício foi desenvolvido para a disciplina de **Lógica de Programação**, aplicando conceitos de **raciocínio lógico**, **fatos e regras** para inferência automatizada 🤓.

## ⚡ Funcionalidades
- Representação de **fatos e regras** em Prolog 📜.
- Dedução das características de cada motoboy 🧑‍🦰🧑‍🦱🧑‍🦳.
- Determinação das regiões de entrega com base nas pistas 🗺️.
- Exemplo de resolução de problema de lógica complexa em Prolog 🧩.

## 🛠️ Requisitos
- [SWI-Prolog](https://www.swi-prolog.org/) instalado para execução do código 💻.
- Sistema operacional compatível com SWI-Prolog 🖥️.
...
<p align="center">
  <img src="./images/motoboy.jpg" alt="Motoboy Rápido" width="150"/><br/>
</p>
